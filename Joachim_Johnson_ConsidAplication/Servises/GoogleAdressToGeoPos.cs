...
namespace Joachim_Johnson_ConsidAplication.Servises
{
    public class GoogleAdressToGeoPos
    {
        ...
        public static CordinatesModells getCordByPos(string adress, string city)
        {
            CordinatesModells returCord = new CordinatesModells();
        ...
        private static CordinatesModells getcord(String fulladress)
        {
            CordinatesModells returCord = new CordinatesModells();
